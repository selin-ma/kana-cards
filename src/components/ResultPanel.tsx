...
export default function ResultPanel({
  ...
  return (
    <div className='flex flex-col items-center gap-7 text-center w-full max-w-sm'>
      <h2 className='text-lg font-medium' style={{ color: '#6A9070' }}>
        本轮结束
      </h2>

      <div className='flex gap-10'>
        <div>
          <p className='text-3xl font-light' style={{ color: '#7AAA7A' }}>
            {correct.length}
          </p>
          <p className='text-xs mt-1' style={{ color: '#B8C4B8' }}>
            记住了
          </p>
        </div>
        <div>
          <p className='text-3xl font-light' style={{ color: '#C08878' }}>
            {wrong.length}
          </p>
          <p className='text-xs mt-1' style={{ color: '#B8C4B8' }}>
            没记住
        ...
        {skipped.length > 0 && (
          <div>
            <p className='text-3xl font-light' style={{ color: '#B8C4B8' }}>
              {skipped.length}
            </p>
            <p className='text-xs mt-1' style={{ color: '#B8C4B8' }}>
              已跳过
        ...
        <div>
          <p className='text-3xl font-light' style={{ color: pctColor }}>
            {pct}%
          </p>
          <p className='text-xs mt-1' style={{ color: '#B8C4B8' }}>
            正确率
