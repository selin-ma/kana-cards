...
export default function ErrorDashboard({ cardStats, allCards, onPractice }: Props) {
  ...
  const struggling = displayed
    ...
    .sort((a, b) => (cardStats[b.id]?.wrong ?? 0) - (cardStats[a.id]?.wrong ?? 0))
    ...
    <>
      <div className='w-full flex flex-col gap-4'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <button
            onClick={() => onPractice(struggling.length > 0 ? struggling : missed)}
